...
The code for the shiny app is stored in [R](https://github.com/Hack-for-California/General-Plan-Map/R). Running app.R in this folder launches the app, 
loading the CA city shapefiles into a data frame via load_data.R in the [R/data_load_and_clean](https://github.com/Hack-for-California/General-Plan-Map/R/data_load_and_clean) 
folder and calling on ui.R and server.R in the [R/shiny_app](shiny_app) folder. 
...
When a user clicks on the Search button, server.R calls on R_phrase_search_func.R in the [R/data_load_and_clean](https://github.com/Hack-for-California/General-Plan-Map/R/data_load_and_clean) folder,
which calls on basic_search.cpp in the [search_cpp](https://github.com/Hack-for-California/General-Plan-Map/search_cpp) folder. 
...
word_map.txt is created with a C++ called containsWordReverseIndexer0.1.cpp in the [indexing_cpp](https://github.com/Hack-for-California/General-Plan-Map/indexing_cpp) folder.
...
Please see [license](https://github.com/Hack-for-California/General-Plan-Map/master/LICENSE) file for details.
